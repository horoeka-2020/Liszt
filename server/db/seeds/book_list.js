    ...
    .then(function () {
      ...
      return knex('book_list').insert([
        ...
        },
        {
          ...
          description: 'Chronicles the life of the pop music sensation, documenting her early school and pre-fame years, as well as the milestones of her career and the eccentricities of her public image.'
        }
